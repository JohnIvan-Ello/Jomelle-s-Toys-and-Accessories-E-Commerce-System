...
<html>
  <head>
    ...
    <style>
      * {
      ...
      justify-content: center;
      align-items: center;
      min-height: 10vh; /* Ensures the section takes at least the full viewport height */
      text-align: center;
    }
  ...
  <body>
    ...
    <div class="page-holder">
      ...
      <section id="about-us" class="position-relative bg-gray padding-small center-content">
    <div class="col-md-6 mt-5">
      <div class="section-title mb-4">
        <h3>Welcome To Jomelle's Toy and Accessories</h3>
      </div>
      <p>At Jomelle's, we're dedicated to bringing joy and excitement into the lives of children and adults alike through our curated selection of high-quality toys and accessories. As a sole proprietorship business supplying and distributing affordable Toys & Accessories inside Supermarkets, we understand the importance of offering products that spark imagination and foster moments of laughter, learning, and togetherness.
      </p>
      <p>From classic favorites to the latest trends, we handpick each item with care, ensuring endless hours of fun, creativity, and exploration. Whether you're searching for the perfect gift, enhancing playtime adventures, or simply indulging your inner child, Jomelle's is your ultimate destination.</p>
      <hr style="border-color: black;">
      <h5>
      Contact Us:<br>
      Phone: 09394005602<br>
      Email: <a href="mailto:karlmateo28@yahoo.com">karlmateo28@yahoo.com</a><br>
      Facebook: <a href="https://www.facebook.com/JomelleToys" target="_blank">www.facebook.com/JomelleToys</a>
    </h5>
      <a class="btn btn-primary mt-4" href="shop.php">Shop Here</a>
    </div>
  </section>
...
<body class="about-page">
    ...
    <div class="main-container">
        ...
        <div class="team-container">
            <div class="team-card">
                <img src="ge.jpg" alt="">
                <div class="team-name">John Ivan P. Ello</div>
                <div class="designation">Project Manager</div>
                <div class="team-about">John Ivan P. Ello, an adept project manager in web development, orchestrates our online presence at Jomelle's Toys and Accessories. With a proven track record in steering digital projects to success, John Ivan ensures that our website reflects our commitment to quality, innovation, and customer satisfaction.</div>

            </div>

            <div class="team-card">
                <img src="suiz.jpg" alt="">
                <div class="team-name">Charity Joy Ladia</div>
                <div class="designation">Business Analyst</div>
                <div class="team-about">Charity Joy Ladia, our astute business analyst, guides Jomelle's Toys and Accessories with strategic insights and market expertise. Her sharp analysis and deep understanding of consumer behavior steer our decisions, ensuring we consistently deliver delightful experiences to our customers.</div>
                    
            </div>

            <div class="team-card">
                <img src="ja.jpeg" alt="">
                <div class="team-name">Elijah Micah A. Muana</div>
                <div class="designation">Programmer 1</div>
                <div class="team-about">Elijah Micah A. Muana, a skilled front-end programmer, crafts immersive digital experiences at Jomelle's Toys and Accessories. With a keen eye for design and a mastery of coding languages, Elijah brings our website to life, seamlessly blending aesthetics with functionality. Her dedication to user-centric design ensures that every click sparks joy and delight for our customers.</div>

            </div>

            <!-- Add these three blocks after the existing teams -->

            <div class="team-card">
                <img src="franz.jpg" alt="">
                <div class="team-name">Marieton Faith Y. Fernandez</div>
                <div class="designation">Programmer 2</div>
                <div class="team-about">Marieton Faith Y. Fernandez, our adept front-end programmer, shapes the digital realm of Jomelle's Toys and Accessories. With a knack for innovative design and user interaction, Marieton crafts captivating online experiences that delight and engage our audience.</div>
            </div>

            <div class="team-card">
                <img src="drey.jpg" alt="">
                <div class="team-name">Isaiah Vincent M. Alindada</div>
                <div class="designation">Programmer 3</div>
                <div class="team-about">Isaiah Vincent M. Alindada, our skilled back-end programmer, is the architect of Jomelle's Toys and Accessories' digital infrastructure. With expertise in coding and database management, Isaiah ensures the seamless operation of our website, empowering our platform to adapt and grow alongside our customers' needs.</div>
            </div>

            <div class="team-card">
                <img src="rus.jpg" alt="">
                <div class="team-name">Sunny E. Madridano</div>
                <div class="designation">Tester</div>
                <div class="team-about">Sunny E. Madridano, our meticulous tester, ensures the flawless performance of Jomelle's Toys and Accessories' digital offerings. With a keen eye for detail and a passion for perfection, Sunny meticulously evaluates every aspect of our platform, guaranteeing a seamless user experience for our valued customers. </div>
            </div>
