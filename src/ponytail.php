                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white bg-"></div><a class="d-block" href="detail.php"><img class="img-fluid w-100" src="img/p-4.jpg" alt="..."></a>
                      ...
                      <h6> <a class="reset-anchor" href="detail.php">Assorted Ponytail</a></h6>
