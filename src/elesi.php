        ...
        <section class="py-5">
          <div class="container p-0">
            <div class="row">
              ...
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                  <li class="mb-2"><a class="reset-anchor" href="rubrics.php">Rubrics </a></li>
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white bg-"></div><a class="d-block" href="elesi.php"><img class="img-fluid w-100" src="img/rr-2.jpg" alt="..."></a>
