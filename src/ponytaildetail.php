        ...
        <div class="container">
          <div class="row mb-5">
              ...
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0 px-xl-2">
                  <div class="swiper product-slider-thumbs">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="img/p-4.jpg" alt="..."></div>
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="img/p-3.jpg" alt="..."></div>
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="img/p-2.jpg" alt="..."></div>
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="img/p-1.jpg" alt="..."></div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="swiper product-slider">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="img/p-4.jpg" data-gallery="gallery2" data-glightbox="Product item 1"><img class="img-fluid" src="img/p-4.jpg" alt="..."></a></div>
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="img/p-3.jpg" data-gallery="gallery2" data-glightbox="Product item 2"><img class="img-fluid" src="img/p-3.jpg" alt="..."></a></div>
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="img/p-2.jpg" data-gallery="gallery2" data-glightbox="Product item 3"><img class="img-fluid" src="img/p-2.jpg" alt="..."></a></div>
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="img/p-1.jpg" data-gallery="gallery2" data-glightbox="Product item 4"><img class="img-fluid" src="img/p-1.jpg" alt="..."></a></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              ...
              <h1>Assorted Ponytail</h1>
              <p class="text-muted lead">₱10</p>
              <p class="text-sm mb-4"> Introducing our Assorted Ponytail Hair Accessory Set – a versatile collection featuring hair ties, scrunchies, clips, and ribbons in various colors and styles. Elevate your ponytail with ease and add a touch of flair to any look!</p>
              <div class="row align-items-stretch mb-4">
              <?php
      
      $select_products = mysqli_query($conn, "SELECT * FROM `products` where id = '29'");
          ...
          <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              <div class="p-4 p-lg-5 bg-white">
                ...
                <p class="text-muted text-sm mb-0">Introducing our Assorted Ponytail Hair Accessory Set – a versatile collection featuring hair ties, scrunchies, clips, and ribbons in various colors and styles. Elevate your ponytail with ease and add a touch of flair to any look!</p>
              </div>
            </div>
