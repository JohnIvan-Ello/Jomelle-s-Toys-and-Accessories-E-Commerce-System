          ...
          <div class="row">
              ...
              <form action="#" method = "post">
                <div class="row gy-3">
                  <div class="col-lg-6">
                    ...
                    <input class="form-control form-control-lg" type="text" id="firstName" name = "fname" placeholder="Enter your first name">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="lastName">Last name </label>
                    <input class="form-control form-control-lg" type="text" id="lastName" name = "lname" placeholder="Enter your last name">
                  </div>
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                    ...
                    <input class="form-control form-control-lg" type="tel" name = "number" id="phone" placeholder="e.g. +02 245354745">
                  </div>
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="phone">Phone number </label>
                    <input class="form-control form-control-lg" type="tel" name = "method" id="phone" placeholder="e.g. +02 245354745">
                  </div>
           <!--      <div class="col-lg-6 form-group">
                  ...
                  <div class="col-lg-12">
                    ...
                    <input class="form-control form-control-lg" name = "address" type="text" id="address" placeholder="House number and street name">
                  </div>
                  <div class="col-lg-12">
...
if(mysqli_num_rows($product_query) > 0){
    while($product_quantity = mysqli_fetch_assoc($product_query)){
        $final_quantity = $product_quantity['quantity'] - $fetch_cart['quantity'];
...
?>
       <li class="d-flex align-items-center justify-content-between"><strong class="text-uppercase small fw-bold">Total</strong><span>₱<?php echo $final_quantity; ?></span></li>
                  </ul>
                </div>
              </div>
            </div>
